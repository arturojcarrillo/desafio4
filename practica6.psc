Algoritmo sistemaCompra
	...
	mostrar "El precio en Bolivares del producto es " precio_en_tasa
	
	mostrar "Por favor, indique el porcentaje de descuento: "
	...
	mostrar "El sub total que correponde pagar es: " sub_total "$ o " precio_en_tasa*cantidad " bs"
	...
	mostrar "En Bolivares el precio es: " (billetes - monto_total) * tasa_cambio
